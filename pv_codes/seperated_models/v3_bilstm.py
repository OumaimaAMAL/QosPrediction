# -*- coding: utf-8 -*-
"""
Created on Sun Jul 23 18:35:34 2023
...
modelbilstm.compile(optimizer='adam', loss='mae')
modelbilstm.summary()

# fit the model
historybilstm = modelbilstm.fit(trainX, trainY, epochs=200, batch_size=32, validation_split=0.2, verbose=1)
